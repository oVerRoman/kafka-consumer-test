package com.simbirsoft.kafkaconsumertest.config;
...
public class KafkaConsumerConfig {
    ...
    public KafkaListenerContainerFactory<?> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<Long, EmployeeDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
